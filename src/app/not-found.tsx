...
export default function NotFound() {
  return (
    <div className="dot-grid relative flex min-h-screen flex-col items-center justify-center bg-canvas px-6 py-14 text-center">
      ...
      <Link
        href="/dashboard"
        className="inline-flex animate-[fade-up_0.5s_cubic-bezier(0.16,1,0.3,1)_0.15s_both] items-center gap-2.5"
      >
        <BrandMark size={40} />
        <span className="text-[19px] font-semibold tracking-[0.2em] text-fg">VANTA</span>
      </Link>

      <p className="mt-10 animate-[fade-up_0.5s_cubic-bezier(0.16,1,0.3,1)_0.22s_both] text-[11px] font-semibold uppercase tracking-[0.3em] text-violet">
        404
      </p>
      <h1 className="mt-3 animate-[fade-up_0.5s_cubic-bezier(0.16,1,0.3,1)_0.3s_both] text-[32px] font-semibold tracking-[-0.02em] text-fg lg:text-[40px]">
        This page drifted off the grid
      </h1>
      <p className="mt-3 max-w-md animate-[fade-up_0.5s_cubic-bezier(0.16,1,0.3,1)_0.38s_both] text-[14px] leading-relaxed text-fg-3">
        The page you&apos;re looking for doesn&apos;t exist, was moved, or never made it out of the
        backlog.
      </p>

      <div className="mt-8 flex animate-[fade-up_0.5s_cubic-bezier(0.16,1,0.3,1)_0.46s_both] items-center gap-3">
        <Link
          href="/dashboard"
